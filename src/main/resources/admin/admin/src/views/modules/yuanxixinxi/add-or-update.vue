<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="院系名" prop="yuanximing">
          <el-input v-model="ruleForm.yuanximing" 
              placeholder="院系名" clearable  :readonly="ro.yuanximing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="院系名" prop="yuanximing">
              <el-input v-model="ruleForm.yuanximing" 
                placeholder="院系名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='yuanximing'){
            this.ruleForm.yuanximing = obj[o];
	    this.ro.yuanximing = true;
            continue;
          }
        }
      }
